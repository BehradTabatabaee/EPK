				...
				<div className="sm:container min-w-[60vw] sm:px-6 py-12 mx-auto">
					<div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
						<div className="sm:col-span-2">
							<h1 className="max-w-lg text-base sm:text-lg md:text-xl font-semibold tracking-tight xl:text-2xl text-white font-sans">
								عضویت در خبرنامه
							</h1>
						...
						<div>
							<p className="font-semibold text-white font-sans text-base">دسترسی سریع</p>
							<div className="flex flex-col items-start mt-5 space-y-2 font-vazir">
								<Link
									href="/"
									className=" transition-colors duration-300 text-gray-300 text-base hover:text-blue-500"
								>
									صفحه اصلی
								</Link>
								<Link
						...
						<div>
							<p className="font-semibold text-white font-sans text-base">دفتر مرکزی</p>
							<div className="flex flex-col items-start mt-5 space-y-2 font-vazir">
								<p
									href="#"
									className=" transition-colors duration-300 text-base text-gray-300"
								>
