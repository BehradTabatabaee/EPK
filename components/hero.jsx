...
export default function Hero() {
	return (
		<>
			<div className="flex flex-wrap-reverse justify-center sm:mt-2 min-[512px]:mt-5 mr-0 gap-7 md:mr-0 min-[1440px]:gap-46 min-[1280px]:gap-32 lg:gap-32">
				<div className="flex flex-col sm:mt-2 lg:mt-0 mt-1 mr-2 lg:gap-6 md:gap-9 sm:mr-0 lg:items-center justify-center">
