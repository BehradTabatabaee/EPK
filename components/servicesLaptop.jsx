...
export default function Oil() {
	return (
		<>
			<div className="bg-[url('/laptop.jpg')] md:bg-[url('/laptopmd.jpg')] md:pt-16 lg:pt-20 xl:pt-24 2xl:pt-32 bg-cover bg-opacity-50 bg-no-repeat flex justify-center items-center bg-[#8b8b8b] w-full min-[280px]:h-[46rem] min-[412px]:h-[50rem] min-[500px]:h-[51rem] min-[512px]:h-[52rem] min-[510px]:h-[37rem] h-[55rem] sm:h-[120vh]">
