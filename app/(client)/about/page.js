export default function About() {
	return (
		<div className="lg:container max-w-screen min-w-screen lg:min-w-[70vw]">
			<div className="justify-center p-8 sm:p-12 md:p-16 lg:p-20 xl:p-24 flex flex-col items-center gap-14">
				<div className="h-fit flex flex-col gap-8 sm:gap-10 md:gap-12 lg:gap-14 xl:gap-16 2xl:gap-20 w-full 2xl:justify-center">
					<h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold text-center font-sans">
						اکسیر پویان کارافن در یک نگاه
					</h1>
					<p className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl !leading-loose font-vazir text-center">
