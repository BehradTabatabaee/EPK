...
export default function NotFound() {
    return (
        <main className="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
			...
			<div className="bg-[#FF6A3D] px-2 text-sm rounded rotate-12 absolute font-sans">
			...
			<button className="mt-5">
				<Link href="/" className="relative inline-block text-sm font-medium text-[#FF6A3D] group active:text-orange-500 focus:outline-none focus:ring">
					...
					<span className="relative block px-8 py-3 bg-[#1A2238] border border-current font-sans">
